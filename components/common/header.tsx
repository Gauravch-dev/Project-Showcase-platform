...
const Logo=()=>{
    ...
    <Link href="/" className="flex items-center gap-2 group">
        ...
        <span className="text-xl font-bold "><span className="text-primary">Project</span> Showcase</span></Link>
    );
};
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur support-backdrop-filter:bg-background/60">
                ...
                <nav className="flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <SignedIn>
                            <Button asChild>
                            <Link href="/submit">
                            <SparklesIcon className="size-4"/>Submit Project</Link>
                        </Button>
                            <UserButton />
                        </SignedIn>
                    </div>
